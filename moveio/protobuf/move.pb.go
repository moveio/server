...
type HookServClient interface {
	...
	DeleteHook(ctx context.Context, in *Hook, opts ...grpc.CallOption) (*Hook, error)
}
...
func (c *hookServClient) DeleteHook(ctx context.Context, in *Hook, opts ...grpc.CallOption) (*Hook, error) {
	out := new(Hook)
	err := grpc.Invoke(ctx, "/HookServ/DeleteHook", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HookServServer interface {
	...
	DeleteHook(context.Context, *Hook) (*Hook, error)
}
...
func _HookServ_DeleteHook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Hook)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HookServServer).DeleteHook(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/HookServ/DeleteHook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HookServServer).DeleteHook(ctx, req.(*Hook))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _HookServ_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HookServ_DeleteHook_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protobuf/move.proto",
...
var fileDescriptor0 = []byte{
	...
	,
}
